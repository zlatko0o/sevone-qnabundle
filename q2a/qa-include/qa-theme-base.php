...
//	search() outputs <div class="qa-search">, q_list() outputs <div class="qa-q-list">, etc...
	...
	public function head_css()
	{
		...
		//SevOne Custom:
		//$this->output('<link rel="stylesheet" href="/q2a/'.$this->rooturl.$this->css_name().'"/>');
	...
	public function main()
	{
		...
		//SevOne Custom
		$this->output('<div class="'.$this->template.'-template qa-main'.(@$this->content['hidden'] ? ' qa-main-hidden' : '').'">');
