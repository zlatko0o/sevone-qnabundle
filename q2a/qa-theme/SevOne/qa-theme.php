...
class qa_html_theme extends qa_html_theme_base
{
	...
	public function head_css()
	{
		// add RTL CSS file
		if( $this->isRTL )
			$this->content['css_src'][] = $this->rooturl . '/q2a/qa-styles-rtl.css?' . QA_VERSION;
	...
	{
		//SevOne Custom
		echo '<span class="poweredby">Powered by <a href="http://www.question2answer.org/">Question2Answer</a></span>';
